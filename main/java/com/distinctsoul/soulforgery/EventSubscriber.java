...
public class EventSubscriber {
	...
	public static void registerItems(Register<Item> event) {
			...
			final Item[] items = {
						...
						new Item().setRegistryName("corrupted_soul").setTranslationKey(Main.MODID + "." + "corrupted_soul").setCreativeTab(Main.SOUL_FORGERY),
						...
						new Item().setRegistryName("living_cloth").setTranslationKey(Main.MODID + "." + "living_cloth").setCreativeTab(Main.SOUL_FORGERY),
			...
			new ItemBlock(BlockInit.IGRIAN_ORE).setRegistryName(BlockInit.IGRIAN_ORE.getRegistryName()),
			new ItemBlock(BlockInit.SHARD_FUSER).setRegistryName(BlockInit.SHARD_FUSER.getRegistryName()),
		};
